...
<nav class="navbar expanded navbar-expand-lg">
    ...
    <span class="navbar-brand"><?php echo getbrgyName('captain'); ?></span>
            ...
            <div class="notif-menu">
                ...
                <div class="notif-items-container">
                    ...
                    <?php foreach($notifications as $notif): 
                        // Captain-specific notification URLs:
                        $notifUrl = '#'; 
                        switch($notif['notif_type']) {
                            case 'document_request':
                                $notifUrl = "/Project_A2/pages/captain/documents_for_signing.php?id=" . $notif['notif_entity_id'];
                                break;
                            case 'schedule_update':
                                $notifUrl = "/Project_A2/pages/captain/dashboard.php";
                                break;
                            case 'document':
                                $notifUrl = "/Project_A2/pages/captain/documents_for_signing.php?id=" . $notif['notif_entity_id'];
                                break;
                ...
                <div class="notif-footer">
                    <a href="/Project_A2/pages/captain/notifications.php" class="btn btn-sm btn-outline-primary w-100">View All Notifications</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="profile-dropdown position-relative" onclick="toggleMenu(event)">
        ...
        <div class="sub-menu-wrap" id="subMenu">
            <div class="sub-menu">
                ...
                <hr>
                <a href="activity_logs.php" class="sub-menu-link">
